export const jokes = [
  ...
  },
  {
    id: 400,
    type: "anime",
    setup: "What do you think, Haruhi? Do you find this large crab to be......",
  ...
  },
  {
   ...
   },
   {
    id: 437,
   type: "dad",
   setup: "What do you call a dinosaur with a great vocabulary?",
   ...
   },
   {
    id: 440,
   type: "dad",
   setup: "How does an octopus go into battle?",
   ...
   },
   {
    id: 445,
   type: "dad",
   setup: "How does a vampire start a letter?",
   punchline: "Tomb it may concern...",
   },
   {
    id: 446,
   type: "dad",
   ...
   },
   {
    id: 448,
   type: "dad",
   setup: "Where do fruits go on vacation?",
   punchline: "Pear-is!",
   },
   {
    id: 449,
   ...
   type: "dad",
   setup: "How does a train eat?",
   punchline: "It choo-choos its food!",
   },
   {
    id: 464,
   type: "dad",
   setup: "Why didn't the skeleton go to the party?",
   ...
   type: "dad",
   setup: "Why did the cookie cry?",
   punchline: "Because his father was a wafer so long!",
   },
   {
    id: 467,
   type: "dad",
   setup: "What is a wizard's favorite subject in school?",
   punchline: "Spelling!",
   },
   {
    id: 468,
   ...
   },
   {
    id: 476,
   type: "dad",
   setup: "What’s the first bet that most people make in their lives?",
   punchline: "The alphabet.",
   },
   {
    id: 477,
   type: "dad",
   ...
   },
   {
    id: 479,
   type: "anime",
   setup: "Why did Naruto bring a ladder to the bar?",
   punchline: "Because he heard the drinks were on the house!",
   },
   {
    id: 480,
   type: "anime",
   setup: "How does Kakashi always win arguments?",
   punchline: "He uses his Sharingan to backtrack every word!",
   },
   {
    id: 481,
   type: "anime",
   setup: "Why doesn't Sasuke play hide and seek?",
   punchline: "Because good luck hiding from the Sharingan!",
   },
   {
    id: 482,
   type: "anime",
   setup: "What did Itachi say to Sasuke when he dropped a phone?",
   punchline: "Sharingan can fix that crack.",
   },
   {
    id: 483,
   type: "anime",
   setup: "Why don’t ninjas use iPhones?",
   punchline: "Because they don't want to deal with the Siri-engan!",
   },
   {
    id: 484,
   type: "anime",
   setup: "How did Naruto end up in detention?",
   punchline: "He couldn’t stop shadow cloning himself in class!",
   },
   {
    id: 485,
   type: "anime",
   setup: "What did Naruto say when he won the lottery?",
   punchline: "Believe it!",
   },
   {
    id: 486,
   type: "anime",
   setup: "Why did Gara open a beach resort?",
   punchline: "Because he’s great with sand!",
   },
   {
    id: 487,
   type: "anime",
   setup: "What did Jiraiya do after entering a ramen contest?",
   punchline: "He became a noodle sage!",
   },
   {
    id: 488,
   type: "anime",
   ...
   },
   {
    id: 493,
   type: "programming",
   setup: "Why can't Python finish its breakfast?",
   punchline: "Because it always finds a syntax error in its cereal!",
   },
   {
    id: 494,
   type: "programming",
   setup: "How do functions break up?",
   punchline: "They stop calling each other!",
   },
   {
    id: 495,
   type: "programming",
   ...
   },
   {
    id: 496,
   type: "programming",
   setup: "What did the programmer say when the database failed?",
   punchline: "Keep calm and query on.",
   },
   {
    id: 497,
   type: "programming",
   setup: "Why did the software developer go broke?",
   punchline: "Because he used up all his cache!",
   },
   {
    id: 498,
   type: "programming",
   setup: "What's a programmer’s favorite ocean?",
   punchline: "The C!",
   },
   {
    id: 499,
   type: "anime",
   setup: "Why did Tanjiro bring a broom to the battle?",
   punchline: "To sweep away the demons!",
   },
   {
    id: 500,
   type: "anime",
